...
<body style="background-color: #d7a59a;">
<body>
            ...
            <div class="col-md-6">
                ...
                <form action="/save" method="post">
                    ...
                    <select class="form-control" name="ProductDescription">
                        <option value="T-shirt" <?= (isset($pro['ProductDescription']) && $pro['ProductDescription'] === 'T-shirt') ? 'selected' : '' ?>>T-shirt</option>
                        <option value="Sweatshirt" <?= (isset($pro['ProductDescription']) && $pro['ProductDescription'] === 'Sweatshirt') ? 'selected' : '' ?>>Sweatshirt</option>
                        <option value="Polo" <?= (isset($pro['ProductDescription']) && $pro['ProductDescription'] === 'Polo') ? 'selected' : '' ?>>Polo</option>
